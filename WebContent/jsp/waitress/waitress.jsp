...
<%	
		...
		session.removeAttribute("selectedPersonal");
		session.removeAttribute("editFamilyInfo");
		session.removeAttribute("editPayRecord");
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
            ...
            <li><a href="<%=basePath %>ShowActivity_2">Activity</a></li>
            <li><a href="<%=basePath %>jsp/waitress/arrange.jsp">Arrange activity</a></li>
            <li><a href="<%=basePath %>GetMember">Members</a></li>
