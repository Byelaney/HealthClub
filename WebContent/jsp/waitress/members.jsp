      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
            ...
            <li><a href="<%=basePath %>jsp/waitress/members2.jsp">Family</a>
			...
			<table class="table table-striped table-bordered table-hover datatable">
				...
				<tbody>
					...
					<% 
						...
						%>
					<tr class="odd gradeX">
						<td class="center"><a href="<%=basePath %>ShowPersonal?index=<%=i %>"><%=personal.get(i).getAccount() %></a></td>
						<td class="center"><%=personal.get(i).getPassword() %></td>
						<td class="center"><%=personal.get(i).getGender() %></td>
						<td class="center"><%=personal.get(i).getAge() %></td>
						<td class="center"><%=personal.get(i).getAddress() %></td>	
						<td class="center"><%=personal.get(i).getBankCardAccount() %></td>
						<td class="center"><%=personal.get(i).getMemberstate() %></td>
						<td class="center"><%=personal.get(i).getIdCard() %></td>			
					</tr>
