...
CoachUsePO coachPO=(CoachUsePO)session.getAttribute("coachPO");
%>    
    ...
    <div class="navbar navbar-inverse navbar-fixed-top" role="navigation">
      <div class="container">
        ...
        <div class="collapse navbar-collapse">
          ...
          <li class="active"><a>Coach use</a></li>
            <li ><a href="<%=basePath %>jsp/manager/manager.jsp">Home</a></li>
            <li ><a href="<%=basePath %>GetMonthPOByManager">Month Member</a>
