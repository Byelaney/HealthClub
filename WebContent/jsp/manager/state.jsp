...
function myFunction(){
	...
	var data = {
			labels : ["Normal","Cease","Pause","Cancel"],
			datasets : [
				{
					fillColor : "rgba(220,220,220,0.5)",
					strokeColor : "rgba(220,220,220,1)",
					data : [<%=memberInfoPO.getNormal() %>,
					        <%=memberInfoPO.getCease() %>,
					        <%=memberInfoPO.getPause() %>,
					        <%=memberInfoPO.getCancel() %>]
				}
			]
		};
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
            <li  class="active"><a>Member State</a></li>
            <li><a href="<%=basePath %>jsp/manager/gender.jsp">Member Gender</a></li>
            <li><a href="<%=basePath %>jsp/manager/memberInfoPO.jsp">Member Age</a></li> 
