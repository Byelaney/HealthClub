...
<div class="container-fluid">
	 ...
	 <div class="alert alert-success">
        <strong>Well done!</strong> Your operation is successfully done.
      </div>

	<p>
		 <button type="button" class="btn btn-lg btn-success" onclick="document.location=('<%=basePath %>jsp/manager/manager.jsp')">back</button>
	</p>
