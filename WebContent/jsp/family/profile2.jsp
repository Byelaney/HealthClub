...
<div class="container-fluid">
	...
	<p id="submitButton">
		 <button type="button" class="btn btn-success" onclick="document.location=('<%=basePath %>jsp/family/edit2.jsp')">Edit All</button>
	</p>
